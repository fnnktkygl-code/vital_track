...
async function run() {
  console.log('🚀 Capture de la page Ressources pour vérifier les cartes Ehret et Dr. Morse...');
  ...
  await server.listen();
  const baseUrl = server.resolvedUrls.local[0] || 'http://localhost:5245';
  ...
  await page.screenshot({
    path: path.join(ARTIFACTS_DIR, 'resources_catalog_updated.png'),
    fullPage: false
  });
  console.log('  📸 Capture terminée : resources_catalog_updated.png !');
