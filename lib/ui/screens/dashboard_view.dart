...
class _DietPlanDashCard extends StatelessWidget {
  const _DietPlanDashCard();
  ...
  Widget _activePlanRow(BuildContext context, DietPlan plan, AppColors colors) {
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Créer mon plan alimentaire',
                  style: Theme.of(context)
                      .textTheme
                      .titleSmall
                      ?.copyWith(color: colors.accent, fontSize: 14)),
              Text('Ehret · Dr. Sebi · Dr. Morse · Personnalisé',
                  style: Theme.of(context).textTheme.labelMedium),
            ],
          ),
        ),
