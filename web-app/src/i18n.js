...
export const TRANSLATIONS = {
  fr: {
    ...
    scanner: {
      ...
      detectiveBadge: 'Arnold le Détective Nutritionnel ausculte votre plat',
    ...
    chat: {
      ...
      welcomeSub: 'Je suis ton coach vitaliste IA. Pose-moi une question sur la nutrition, le jeûne, les plantes ou la santé naturelle.',
      inputPlaceholder: 'Pose ta question ou décris tes symptômes...',
      thinkingStatus: 'Arnold inspecte la mémoire & analyse...',
    ...
    settings: {
      ...
      mascotTitle: 'Compagnon Mascotte Vitale',
  ...
  'fr-CA': {
    ...
    chat: {
      welcomeTitle: 'Roucouuu ! 🌿',
      welcomeSub: 'Je suis ton coach vitaliste IA. Pose-moi une question sur la nutrition, le jeûne, les plantes boréales ou la santé naturelle.',
  ...
  en: {
    ...
    scanner: {
      ...
      detectiveBadge: 'Arnold the Nutritional Detective is examining your dish',
    ...
    chat: {
      ...
      welcomeSub: 'I am your AI Vitalist Coach. Ask me anything about nutrition, fasting, botanicals, or natural healing.',
      inputPlaceholder: 'Ask a question or describe your meal...',
      thinkingStatus: 'Arnold is inspecting memories & analyzing...',
  ...
  es: {
    ...
    scanner: {
      ...
      detectiveBadge: 'Arnold el Detective Nutricional está examinando tu plato',
    ...
    chat: {
      welcomeTitle: '¡Rucuuu! 🌿',
      welcomeSub: 'Soy tu coach vitalista con IA. Pregúntame sobre nutrición, ayuno, plantas medicinales o regeneración natural.',
      inputPlaceholder: 'Haz tu pregunta o describe tus alimentos...',
      thinkingStatus: 'Arnold está inspeccionando la memoria y analizando...',
