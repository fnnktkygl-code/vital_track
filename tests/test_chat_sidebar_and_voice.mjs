...
const requiredChatKeys = [
  ...
  'voiceCancel', 'voiceDone', 'voiceTooltip'
];
...
console.log('✅ 1. All chat sidebar and voice i18n keys exist across all 4 locales (FR, EN, ES, FR-CA).');
...
console.log('✅ 2. index.html contains all required sidebar and voice UI elements.');
...
console.log('✅ 3. main.js voice audio synthesis, continuous recording, and API integration verified.');
